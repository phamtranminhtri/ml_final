...
% ==================================================
\textbf{Phương pháp xây dựng mô hình}
...
\textbf{Nhãn và biểu diễn one-hot}
...
% ==================================================
\textbf{Mở rộng cho đường biên phi tuyến}
...
\textbf{MLP: Computational Architecture View}
...
\textbf{SVM với \texttt{scikit-learn}}
...
% =====================================================
\textbf{Phương pháp xây dựng bộ phân lớp}
...
% =====================================================
\textbf{Bài toán gốc (Primal Problem)}
...
\textbf{Giới thiệu bài toán không khả tách tuyến tính}
