...
% =====================================================
\subsection{Hồi quy cho quan hệ phi tuyến}
...
% =====================================================
\subsection{Dự báo cho nhiều biến}
...
% ==================================================
\subsection{Phương pháp xây dựng mô hình}
...
% ==================================================
\subsection{Ước lượng tham số của mô hình}
...
% ==================================================
\subsection{Mô hình tuyến tính với Softmax}
...
% ==================================================
\subsection{Hàm mục tiêu và tối ưu}
...
% ==================================================
\subsection{Mở rộng cho đường biên phi tuyến}
...
\subsection{MLP: Computational Architecture View}
...
% ======================================================
\subsection{MLP: Mathematical Model}
...
\item \textbf{Update step}: update parameters using an optimizer.
\end{enumerate}
...
\subsubsection{AdamW}
AdamW decouples weight decay from the gradient update, improving
generalization, especially in large-scale models.
...
Batch Normalization and Layer Normalization stabilize training and allow
larger learning rates.

\subsection{Practical Considerations}
\subsubsection{Initialization}
Xavier initialization is suitable for sigmoid/tanh, while He initialization
is designed for ReLU activations.

\subsubsection{Gradient Issues}
Vanishing and exploding gradients can be mitigated using ReLU activations,
...
% =====================================================
\subsection{Phương pháp xây dựng bộ phân lớp}
...
% =====================================================
\subsection{Bài toán gốc (Primal Problem)}
...
% =====================================================
\subsection{Xây dựng hàm đối ngẫu}
...
\subsection{Giới thiệu bài toán không khả tách tuyến tính}
...
%------------------------------------------------
\subsection{Nguyên tắc Soft Margin}
...
%------------------------------------------------
\subsection{Bài toán gốc với lề mềm}
...
\subsection{SVM hai lớp với lề mềm}
...
\subsection{Khi đường biên giới phi tuyến}
...
\subsection{Huấn luyện và dự báo với Kernel}
Ma trận Gram kernel:
\begin{equation}
K_{Gram} =
\begin{bmatrix}
...
\subsection{Các kernel thông dụng}
...
\subsection{Kiến thức toán học liên quan}
...
\subsection{Cơ sở lý luận của PCA}
...
\subsection{Cực đại hóa phương sai}
...
% ==========================================================
\subsection{Trường hợp có $C$ lớp}
...
% --------------------
\subsection{Voting and Stacking}
...
\subsection{Key Components of Genetic Algorithms}
...
\subsection{Parameters and Tuning}
